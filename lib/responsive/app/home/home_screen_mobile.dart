...
class _HomePageState extends State<HomePageMobile>
  ...
  String getCurrentTime() {
    ...
    if (currentIndex == 0) {
      return MyLocalizations.translate("text_Morning_Homepage")+' 08:30-09:30 am 📸';
    } else if (currentIndex == 1) {
      return MyLocalizations.translate("text_Afternoon_Homepage")+' 13:00-14:00 pm 📸';
    } else if (currentIndex == 2) {
      return MyLocalizations.translate("text_Evening_Homepage")+' 18:00-19:30 pm 📸';
    }
  ...
  String getHelloText() {
    if (currentUser.containsKey('name')) {
      ...
      return MyLocalizations.translate("text_Hello_Homepage")+', $name';
    } else {
      return MyLocalizations.translate("text_Hello_Homepage");
    }
  }
                                  ...
                                  Positioned(
                                    ...
                                    child: badges.Badge(
                                      ...
                                      badgeContent: Container(
                                        width: 8,  // Adjust the width and height to control the size of the red dot
                                        height: 8,
                                        decoration: BoxDecoration(
                                      ...
                                      showBadge: shouldShowNotification, // Set the flag here
                                    ),
                                  ),
                                ],
                              ),
                  ...
                  children: [
                    if (currentIndex == 0)
                      isCheckInEnabled
                        ...
                        title: MyLocalizations.translate("text_Morning_Homepage"),
                      )
                          : LongButtonDisable(
                        title: MyLocalizations.translate("text_Morning_Homepage"),
                    ...
                    if (currentIndex == 1)
                      isCheckInEnabled
                        ...
                        title: MyLocalizations.translate("text_Afternoon_Homepage"),
                      )
                          :  LongButtonDisable(
                        title: MyLocalizations.translate("text_Afternoon_Homepage"),
                        textColor: Colors.white,
                    ...
                    if (currentIndex == 2)
                      isCheckInEnabled
                        ...
                        title: MyLocalizations.translate("text_Evening_Homepage"),
                      )
                          : LongButtonDisable(
                        title: MyLocalizations.translate("text_Evening_Homepage"),
                        textColor: Colors.white,
