...
class ApprovalPageMobile extends StatefulWidget {
  const ApprovalPageMobile({Key? key}) : super(key: key);

  @override
  State<ApprovalPageMobile> createState() => _ApprovalPageState();
}
...
class _ApprovalPageState extends State<ApprovalPageMobile>
